...
import com.horionDev.climbingapp.managers.location.extension.OnAlwaysAllowsPermissionRequiredBlock
...
import com.horionDev.climbingapp.managers.location.utils.Version
...
internal actual class LocationLoyal {
    ...
    actual fun stopLocationUpdating() {
        if (!iosLocationProvider.locationServicesEnabled) {
            return
        }
