...
struct MapDealersScrollView<Content: View>: UIViewRepresentable {
    ...
    func getVisibleItemFromOffset(offset: CGFloat, direction : ScrollingDirection) -> Dealer {
